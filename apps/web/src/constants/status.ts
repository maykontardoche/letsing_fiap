 ...
 */
export const STATUS_DO_DOCUMENTO: Record<
  StatusDoDocumento,
  { rotulo: string; tom: TomDeEtiqueta; icone: LucideIcon; ordem: number }
> = {
...
export const STATUS_DO_SIGNATARIO: Record<
  StatusDoSignatario,
  { rotulo: string; tom: TomDeEtiqueta; icone: LucideIcon }
> = {
...
export const VERIFICACAO: Record<
  TipoDeVerificacao,
  { rotulo: string; curto: string; icone: LucideIcon }
> = {
...
export const NIVEIS: Record<
  NivelDeVerificacao,
  { rotulo: string; descricao: string; verificacoes: TipoDeVerificacao[] }
> = {
  simples: {
    rotulo: 'Simples',
